...
# env = "dev"
# repos_path = "/Repos/DATTA-MVP2/DATTA-FI-EH"
...
dlt_table_list = ['FACT_FI_GL_ACCOUNTING_STN','FACT_FI_GL_ACCOUNTING_TSAP','FACT_FI_GL_BALANCE_STN','FACT_FI_GL_BALANCE_TSAP']

print("creating EH tables in UC")
create_UC_table(eh_folder_path,uc_catalog_name,uc_eh_schema,"eh", dlt_table_list)
