...
expected_schema_to_tables = {
    euh_schema: {"bseg_stn","bseg_tsap","bkpf_stn","bkpf_tsap","glidxa_stn","glidxa_tsap"
    },
    eh_schema: {
        "fact_fi_gl_balance_stn","fact_fi_gl_balance_tsap","fact_fi_gl_accounting_stn","fact_fi_gl_accounting_tsap",
    },
}
...
actual_schema_to_tables = (
    spark
        ...
        .filter(col('table_name').isin(["bseg_stn","bseg_tsap","bkpf_stn","bkpf_tsap","glidxa_stn","glidxa_tsap","fact_fi_gl_balance_stn","fact_fi_gl_balance_tsap","fact_fi_gl_accounting_stn","fact_fi_gl_accounting_tsap",]))
