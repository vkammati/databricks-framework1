...
fi_d_hana_workflow_suffix = "D-HANA-"+args.deployment_type
fi_d_hana_workflow_name = get_wrapping_workflow_name(args.repository, args.branch_name, fi_d_hana_workflow_suffix)
fi_hana_sec_workflow_suffix = "HANA-"+args.deployment_type
fi_hana_security_workflow_name = get_security_wrapping_workflow_name(args.repository, args.branch_name, fi_hana_sec_workflow_suffix)
optimize_vacuum_wrapping_workflow_name = get_optimize_vacuum_wrapping_workflow_name(args.repository, args.branch_name, args.deployment_type)
...
fi_d_hana_unique_repo_branch_id = get_unique_repo_branch_id(args.repository, args.branch_name, fi_d_hana_workflow_suffix) if args.env == "dev" else ""
...
fi_d_hana_reset_uc_and_adls_conf_str = fi_d_hana_reset_uc_and_adls_conf_template.render(
    ...
    unique_repo_branch_id_schema=unique_repo_branch_id,
    dlt_pipeline_id=fi_d_hana_dlt_pipeline_id if dlt_pipeline_id else "",
    env=args.env,
    timeout=args.timeout,
...
if args.env == "dev":
    ...
    delete_workflow_by_name(fi_d_hana_workflow_name, args.host, http_header)
    delete_workflow_by_name(fi_hana_security_workflow_name, args.host, http_header)
